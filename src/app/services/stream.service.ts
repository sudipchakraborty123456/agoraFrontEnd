...
export class StreamService {
  ...
  options = {
    appId: 'cd2d570b14e543cd96404622fa2bd8c7',  // set your appid here
    channel: 'test', // Set the channel name.
    token: '6a5580072932463fbea5b9cf49353507', // Pass a token if your project enables the App Certificate.
    // uid: null
  };
